$(function () {
  setInterval(function () {
    ...
    if (secondsOne == "0") {
      ...
      $("#secondsOneplace").addClass("num0");
    } else if (secondsOne == "1") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num1");
    } else if (secondsOne == "2") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num2");
    } else if (secondsOne == "3") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num3");
    } else if (secondsOne == "4") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num4");
    } else if (secondsOne == "5") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num5");
    } else if (secondsOne == "6") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num6");
    } else if (secondsOne == "7") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num7");
    } else if (secondsOne == "8") {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num8");
    } else {
      $("#secondsOneplace").removeClass();
      $("#secondsOneplace").addClass("num9");
    }
  }, 1000);
});